        ...
        <div class="row">
          <div class="col large-7">
            <div class="step-title">
              <h2 class="title">
                <?php echo (__("Step 1: Select Order Quantity", "mwc")) ?>
              </h2>
            </div>
                    ...
                    <label class="js-unitDiscountRate">
                      <div class="product-name">
                        ...
                        <p class="prod_prices">
                          ...
                          <del style="color: #ff0000;"><?php echo ($currency . ' ' . $product_price . '/' . __('each', 'mwc')) ?></del>
                          <strong><span class="discounted_price"><?php echo ($currency . ' ' . round($i_price, 2) . '/' . __('each', 'mwc')) ?></span></strong>
                          <strong><?php echo (__('Total', 'mwc')) ?>: <span class="total_price"><?php echo ($currency . round($i_price_total, 2)) ?></span></strong>
                        </p>
                      </div>
                    </label>
                  </div>
